/**
 * Basic smoke-test script that starts as many timers as can fit in memory (about 60),
...
void setup()
{
    ...
    for (uint32_t i = 0u; i < NUM_SINGLE_TEST_TIMERS; i++)
    {
        ...
        test_timers[i].period = period_ms;
